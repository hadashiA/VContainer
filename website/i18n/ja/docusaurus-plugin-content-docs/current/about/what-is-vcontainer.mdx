...
VContainerの "V" は、Unity の頭文字 "U" を スリムにした形状をイメージして名付けられました…!
...
- **イミュータブルなコンテナ:** 実行中の競合問題の心配がありません。デフォルトでスレッドセーフ。
...
- [PlayerLoopSystem上への ピュアC#  のスケジュール](/integrations/entrypoint)
