...
Since the added code is in C#, it is more debuggable and maintainable than IL code generation or ExpressionTree at runtime.
...
Select `VContainer.SourceGenerator.dll` in the project.
And, click the label icon at the bottom of the inspector window.
