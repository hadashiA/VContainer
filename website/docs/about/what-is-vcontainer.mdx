...
description: VContainer - A fastest DI (Dependency Injection) for Unity (Game Engine)
slug: /
---
...
A fatest DI (Dependency Injection) for Unity (Game Engine). "V" means making Unity's initial "U" more thinner and solid..!
