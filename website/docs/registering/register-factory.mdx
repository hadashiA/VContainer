...
To use this factory as a `Func<>` without knowing or caring about the `FooFactory` class, this is what you can do.
...
var factory = container.Resolve<Func<int, Foo>>(); // Dependency resolution occurs

var foo1 = factory.Create(1);
