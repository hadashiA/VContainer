...
sidebar_label: Register via Delegate
---
...
```
See [Container API](../resolving/container-api.mdx) for more information.

:::note
These delegates will be executed only once during scope construction.
If you want to create an instance at any time during runtime, please refer to [Register Factory](./register-factory.mdx).
:::
